          ...
          <>
                ...
                <div key={booking.id} class="card bg-base-100 shadow-md">
                  <div class="card-body">
                    <div class="flex justify-between">
                      <strong>{t("app.booking.specialist@@Specialist")}:</strong>
            ...
            {showConfirmModal.value && (
              <div class="modal modal-open">
                <div class="modal-box">
                  <h3 class="font-bold text-lg">{t("app.booking.confirm_deletion@@Confirm Deletion")}</h3>
                  <p class="py-4">{t("app.booking.do_you_really@@Do you really want to delete this booking?")}</p>
                  <div class="modal-action">
                    <button class="btn" onClick$={() => (showConfirmModal.value = false)}>
