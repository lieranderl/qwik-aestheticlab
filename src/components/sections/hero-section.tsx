	...
	return (
		...
		>
			<div class="hero-content flex flex-col items-center gap-8 text-center md:gap-14">
				<h1 class="max-w-none font-cormorant text-[clamp(1.5rem,4.5vw,1.875rem)] leading-[1.1] font-normal italic whitespace-nowrap text-primary-content/80 md:text-5xl lg:text-6xl">
