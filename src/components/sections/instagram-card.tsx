	...
	return (
		<>
			<blockquote
				...
				style="background:#FFF; border:0; border-radius:10px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:326px; min-width:326px; padding:0; "
			>
				<div class="p-4">
					<a
						href={`https://www.instagram.com/reel/${post_id}/?utm_source=ig_embed&utm_campaign=loading`}
					...
					>
						...
						<div class="flex flex-col justify-center mb-6">
							<div class="bg-gray-200 rounded-md h-3 mb-2 w-56" />
							<div class="bg-gray-200 rounded-md h-3 w-36" />
						</div>
					</a>
					<p class="text-gray-400 text-sm text-center mt-2 mb-0 overflow-hidden px-2 py-1">
						<a
							href={`https://www.instagram.com/reel/${post_id}/?utm_source=ig_embed&utm_campaign=loading`}
